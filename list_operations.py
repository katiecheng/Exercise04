...
def custom_reverse(input_list):
    ...
    for switch_pairs in range(length/2):
        counter += 1
        pl = input_list[counter]
        input_list[counter] = input_list[length-(counter+1)]
        input_list[length-(counter+1)] = pl

    # pl = input_list[0]
    # input_list[0] = input_list[length-1]
    # input_list[length-1] = pl

    # pl = input_list[1]
    # input_list[1] = input_list[length-2]
    # input_list[length-2] = pl
